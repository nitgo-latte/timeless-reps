...
@TypeGraphQL.InputType("BreathingChainUpdateOneRequiredWithoutExercisingSessionsNestedInput", {
  isAbstract: true
})
export class BreathingChainUpdateOneRequiredWithoutExercisingSessionsNestedInput {
