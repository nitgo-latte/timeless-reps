...
const modelsInfo = {
  ...
  ExercisingSession: ["id", "exerciseId", "message"],
...
const outputsInfo = {
  ...
  ExercisingSessionGroupBy: ["id", "exerciseId", "message", "_count", "_min", "_max"],
  AggregateTimeBox: ["_count", "_min", "_max"],
  TimeBoxGroupBy: ["id", "createdAt", "updatedAt", "closedAt", "resting", "exercisingSessionId", "_count", "_min", "_max"],
  ...
  ExercisingSessionCountAggregate: ["id", "exerciseId", "message", "_all"],
  ExercisingSessionMinAggregate: ["id", "exerciseId", "message"],
  ExercisingSessionMaxAggregate: ["id", "exerciseId", "message"],
...
const inputsInfo = {
  ...
  ExercisingSessionWhereInput: ["AND", "OR", "NOT", "id", "exercise", "exerciseId", "message", "TimeBox"],
  ExercisingSessionOrderByWithRelationInput: ["id", "exercise", "exerciseId", "message", "TimeBox"],
  ExercisingSessionWhereUniqueInput: ["id", "exerciseId"],
  ExercisingSessionOrderByWithAggregationInput: ["id", "exerciseId", "message", "_count", "_max", "_min"],
  ExercisingSessionScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "exerciseId", "message"],
  ...
  TimeBoxOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "closedAt", "resting", "exercisingSessionId", "_count", "_max", "_min"],
  ...
  ExercisingSessionCreateInput: ["id", "exercise", "message", "TimeBox"],
  ExercisingSessionUpdateInput: ["id", "exercise", "message", "TimeBox"],
  ExercisingSessionCreateManyInput: ["id", "exerciseId", "message"],
  ExercisingSessionUpdateManyMutationInput: ["id", "message"],
  ...
  ExercisingSessionCountOrderByAggregateInput: ["id", "exerciseId", "message"],
  ExercisingSessionMaxOrderByAggregateInput: ["id", "exerciseId", "message"],
  ExercisingSessionMinOrderByAggregateInput: ["id", "exerciseId", "message"],
  ...
  ExercisingSessionCreateWithoutExerciseInput: ["id", "message", "TimeBox"],
  ...
  ExercisingSessionScalarWhereInput: ["AND", "OR", "NOT", "id", "exerciseId", "message"],
